<?php
    ...
    $sql_search_Author="";
    $have_AuthorSearch=FALSE;

    $ganre_search=$_REQUEST["ganre"];
    $have_ganre=FALSE;
    if(strlen($ganre_search)>0){
        $have_ganre=TRUE;
    ...
    if(isset($_REQUEST["byAuthor"])){
        $search_author=$_REQUEST["byAuthor"];
        $have_AuthorSearch=TRUE;
        if(isset($_REQUEST["byName"])){
            $search_name=$_REQUEST["byName"];
            #echo($search_name);
        }else{
    ...
    <div style="direction:ltr; font-family:Tahoma; color:#000000; font-size:10pt; ">
        <div id="container" >
            ...
            <div id="content">
                ...
                <h1><i>
                        <font color="#19617E">Books may well be the only true magic</font>
                    </i>
                </h1>
                
                <img src="pictures/Search_book_1.jpg" width="100%" >
                <p> <font color="white"><h3> <br></h2></font></p>
                <div class="title_bar">
                    <h2>
                        <font color="#f0f0f0">Search result</font>
                    </h2>
                </div>
