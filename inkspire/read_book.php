    ...
    <div style="direction:ltr; font-family:Tahoma; color:#000000; font-size:10pt; ">
        <div id="container" >
            ...
            <div id="content">
                ...
                <h1><i>
                        <font color="#19617E">A book is a gift you can open again and again</font>
                    </i>
                </h1>
                <img src="pictures/Reading_4.jpg" width="100%" height="390">
                ...
                <h2><i>
                        <font color="#19617E" >Book's Content: </font>
                ...
                <?php
                    ...
                    foreach($chapters as $x){
                        ...
                        echo("<td>");
                        #$url_string=''
                        echo('<a href="/inkspire/read_book_chapter.php?chapterID='.$x["ID"].'&BookID='.$booksID.'&BookName='.$BookName.'">Read</a>');
                        echo("</td>");
