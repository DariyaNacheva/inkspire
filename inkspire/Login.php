    ...
    <div style="direction:ltr; font-family:Tahoma; color:#000000; font-size:10pt; ">
        <div id="container" >
            ...
            <div id="content">
                ...
                <h1><i>
                        <font color="#19617E">Login to Inkspire WEB Site</font>
                    </i>
                </h1>
                <div class="title_bar">
                    <h2>
                        <font color="#f0f0f0">Please Login with Yor Credential</font>
                    </h2>
                </div>
                ...
                <p> <font color="white">a</font></p>
                <form method="POST" name="login" action="/inkspire/action_page.php">
                    <label for="fname"><h2>Login name:</h2></label><br>
                    <input type="text" id="lname" name="lname">
                    <label for="lname"><h2>Password:</h2></label>
                    <input type="password" id="lpassword" name="lpassword" ><br><br>
                    <br>
                    <input type="submit" name="login" style="font-size: 24pt;" value="Submit">
                </form> 
                <p></p><br>
