    ...
    <div style="direction:ltr; font-family:Tahoma; color:#000000; font-size:10pt; ">
        <div id="container" >
            ...
            <div id="content">
                ...
                <h1><i>
                        <font color="#19617E">If a story is in you, it has to come out!</font>
                    </i>
                </h1>
                <img src="pictures/writing_2.jpg" width="100%" height="390">
                <div class="title_bar">
                    <h2>
                        <font color="#f0f0f0">All Your writing stories</font>
                    </h2>
                </div>
                ...
                <?php
                    ...
                    foreach($books as $x){
                        ...
                        echo("<td>");
                        #$url_string=''
                        echo('<a href="/inkspire/edit_book.php?bookID='.$x["ID"].'">Edit</a>');
                        echo("</td>");
                ...
                <p> <font color="white">a</font></p>
                <form method="POST" name="NewBook" action="/inkspire/Create_new_Book.php">
                    <br>
                    <input type="submit" name="logout" style="font-size: 24px;" value="Start writing new book">
                </form> 
                <p></p><br>
